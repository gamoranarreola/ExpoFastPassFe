...
import { ScrollView,View,Modal,StyleSheet,TouchableOpacity } from 'react-native';
    ...
    <>
      <Surface style={styles.surfaceVisitors}>
        ...
        <Text variant="bodyMedium" style={styles.bodyText}>
          {lang.visitors.moreInfo[language]} <Text variant="bodyMedium" style={styles.linkText}>http://www.tijuana.gob.mx/</Text>
        </Text>
...
backgroundColor:'#333', alignItems:'flex-end', padding:RFValue(20)}}>
...
<View style={{flex:10, width:'100%',justifyContent:'space-evenly', padding:RFValue(20)}}>
  <BarCodeScanner
        onBarCodeScanned={scanned ? undefined : handleBarCodeScanned}
        style={StyleSheet.absoluteFillObject}
      />      
      {scanned && 
       <Button style={{marginTop:RFValue(20)}} icon="camera" buttonColor="#333" color="#fff" mode="contained"
...
<SafeAreaView style={{flex:1, 
  ...
  backgroundColor:'#333', alignItems:'flex-end', padding:RFValue(20)}}>
      ...
      <Text style={[styles.bodyText,{fontSize:RFValue(20), marginLeft:RFValue(65)}]}> 
       {lang.visitors.newPass[language]} </Text>
 ...
 {!manualCapVisible &&<Surface style={{padding:RFValue(20)}}>
  <Text> {lang.visitors.scanCodeTitle[language]} </Text>
  
  <Button style={{marginTop:RFValue(20)}} icon="camera" buttonColor="#333" color="#fff" mode="contained"
   onPress={() => {setVisible(false); setScanVisible(true)}}>    
    {lang.visitors.btnScanTitle[language]}
  </Button>

  {scanText !='' &&<View style={{borderTopWidth:2, borderTopColor:'#bbb', marginTop:RFValue(10), padding:RFValue(10)}}>
  ...
  {!manualCapVisible && <Button  style={{marginTop:RFValue(20)}}  buttonColor="#333" color="#fff" mode="contained" 
  onPress={() => setManualCapVisible(true)}>    
    {lang.visitors.btnCaptureInfoTitle[language]}
  </Button>}
{manualCapVisible && 
<View style={{borderTopWidth:2, borderTopColor:'#bbb', marginTop:RFValue(10), padding:RFValue(10)}}>
...
<TextInput
    ...
    />
    <Button  style={{marginTop:RFValue(20)}}  buttonColor="#333" color="#fff" mode="contained" onPress={() => setManualCapVisible(false)}>    
