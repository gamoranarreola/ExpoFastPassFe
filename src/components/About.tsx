...
const About: React.FC = (props) => {
  ...
  return (
    <ScrollView style={styles.p20}>
      <Text style={[styles.titleTextBlk]}>
        {lang.about.fastlane[language]}:
      </Text>
      <Divider style={styles.my10} />
      <Text style={[styles.bodyTextBlk]}>{lang.about.notValid[language]}</Text>
      <Divider style={styles.my10} />
      <Text style={[styles.bodyTextBlk]}>
        {lang.about.singleTrip[language]}
      </Text>
      <Divider style={styles.my10} />
      <Text style={[styles.bodyTextBlk]}>
        {lang.about.courtesyPass[language]}
      </Text>
      <Divider style={styles.my10} />
      <Text style={[styles.bodyTextBlk]}>
        {lang.about.unlawfulReproduction[language]}
      </Text>
      <Divider style={styles.my10} />
