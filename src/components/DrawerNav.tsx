...
import {
  ...
  View,
  Image,
  TouchableOpacity,Modal,FlatList, ScrollView,Dimensions
} from 'react-native';
...
const DrawerNav: React.FC = () => {
  ...
  return (
    ...
    <NavigationContainer independent>       
      ...
      >
        <Drawer.Screen name={lang.drawerNav.home[language]} component={Visitors} />
        <Drawer.Screen name={lang.drawerNav.about[language]} component={About} />
        <Drawer.Screen name={lang.drawerNav.howToArrive[language]} component={HowToArrive} />
        <Drawer.Screen name={lang.drawerNav.settings[language]} component={Settings} />                 
      </Drawer.Navigator>
